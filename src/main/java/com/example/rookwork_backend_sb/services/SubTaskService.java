...
/**
 * Service class handling operations on subtasks, including creation, status
...
public class SubTaskService {
         ...
         * @throws ForbiddenException        if the user is not a project member
         * @throws ResourceNotFoundException if the project, issue, or subtask is not
         *                                   found
         */
        @Transactional
         ...
         * @throws ForbiddenException        if user is not a project member or is not
         *                                   the project owner
         * @throws ResourceNotFoundException if the project, issue, or subtask is not
         *                                   found
         */
